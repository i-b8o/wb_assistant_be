...
var file_service_proto_rawDesc = []byte{
	...
	0x0d, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xe8,
	0x03, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x37,
...
var file_service_proto_goTypes = []interface{}{
	...
	(*MailConfirmRequest)(nil),                   // 7: MailConfirmRequest
	(*ResetRequest)(nil),                         // 8: ResetRequest
	(*CreateUserResponse)(nil),                   // 9: CreateUserResponse
	(*InsertEmailConfirmTokenResponse)(nil),      // 10: InsertEmailConfirmTokenResponse
	(*CheckAndDelEmailConfirmTokenResponse)(nil), // 11: CheckAndDelEmailConfirmTokenResponse
	(*GenerateTokenResponse)(nil),                // 12: GenerateTokenResponse
	(*ParseTokenResponse)(nil),                   // 13: ParseTokenResponse
	(*User)(nil),                                 // 14: User
	(*UpdateResponse)(nil),                       // 15: UpdateResponse
	(*MailConfirmResponse)(nil),                  // 16: MailConfirmResponse
...
var file_service_proto_depIdxs = []int32{
	...
	7,  // 7: MailService.confirm:input_type -> MailConfirmRequest
	8,  // 8: MailService.reset:input_type -> ResetRequest
	9,  // 9: AuthService.createUser:output_type -> CreateUserResponse
	10, // 10: AuthService.insertEmailConfirmToken:output_type -> InsertEmailConfirmTokenResponse
	11, // 11: AuthService.checkAndDelEmailConfirmToken:output_type -> CheckAndDelEmailConfirmTokenResponse
	12, // 12: AuthService.generateToken:output_type -> GenerateTokenResponse
	13, // 13: AuthService.parseToken:output_type -> ParseTokenResponse
	14, // 14: AuthService.getDetails:output_type -> User
	15, // 15: AuthService.update:output_type -> UpdateResponse
	16, // 16: MailService.confirm:output_type -> MailConfirmResponse
	17, // 17: MailService.reset:output_type -> ResetResponse
